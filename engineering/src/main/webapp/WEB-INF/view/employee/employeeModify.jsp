...
<table border= "1" width="500" align="center">
	...
	<tr><td>입사일</td>
		<td>
			...
			value="<fmt:formatDate value='${emp.hireDate }' type='date' pattern='yyyy-MM-dd' />">
		</td></tr>
	<tr><td>급여</td>
		<td>
	...
	<tr><td colspan=2 align="center">
			...
			<input type="button" value="직원 삭제" onclick="javascript:location.href='empDelete?empNo=${emp.empNo }';"/>
		</td></tr>
</table>
</form>
</body>
